...
*NOTE*: This code repository lists link:FUSE-7.11-UPGRADE-ISSUES.adoc[Issues encountered during the upgrade to Fuse 7.11].

Refer https://access.redhat.com/documentation/en-us/red_hat_fuse/7.11/html-single/fuse_on_openshift_guide/index#create-application-for-spring-boot-2[Creating a Spring Boot 2 project using Maven archetype], on how this example application has been generated.
